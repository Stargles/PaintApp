...
## Corpus Check
- 233 files · ~708,805 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6826 nodes · 20708 edges · 233 communities (211 shown, 22 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 2078 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8207e4e2`
...
Cohesion: 0.09
Nodes (12): HistoryNoticeUITests, PaintUITestCase, Int, String, XCUIApplication, InterpolationWorkflowUITests, Bool, TimeInterval (+4 more)

### Community 1 - "CGPoint"
Cohesion: 0.06
Nodes (28): CGPoint, .length, Int, Corner, bottomLeft, bottomRight, topLeft, topRight (+20 more)
...
Cohesion: 0.03
Nodes (78): Hashable, Never, Void, Kind, folder, layer, MaskSource, folder (+70 more)

### Community 8 - "VectorCanvasData"
Cohesion: 0.08
Nodes (29): ElementData, fill, image, stroke, text, Kind, fill, image (+21 more)
...
### Community 21 - "layers"
Cohesion: 0.11
Nodes (14): .activeLayerIsVector, Int, CanvasManager, Bool, Int, Void, Cel, .endFrame (+6 more)
...
Cohesion: 0.06
Nodes (50): Identifiable, VectorTextElement, CodableColor, .uiColor, image, kind, DabLattice, .range (+42 more)
...
Cohesion: 0.08
Nodes (24): CoreText, FontFace, .descriptor, .id, FontFamilyGroup, .id, FontLibrary, FontProvider (+16 more)
...
### Community 63 - "String"
Cohesion: 0.06
Nodes (36): CaseIterable, Error, Kind, line, oval, rectangle, DecodeReport, .droppedCount (+28 more)
...
Cohesion: 0.04
Nodes (53): CanvasManager, .activeCelIsInBetween, .guideChips, .guideRefusal, .hasAnonymousWholeFrameGroup, .interpolationCommitOptions, .interpolationContentProvider, .interpolationKeyframes (+45 more)

### Community 66 - "View"
Cohesion: 0.12
Nodes (28): stops, View, CodableColor, .color, Color, .effectColor, EffectCatalog, .all (+20 more)
...
Cohesion: 0.05
Nodes (20): bendRatio(), cellSize(), coverage(), cShape(), polyline(), Int, Void, CGFloat (+12 more)

### Community 76 - "CompositorMetalEngine"
Cohesion: 0.11
Nodes (25): Admission, admitted, noHeadroom, overBudget, CompositorMetalEngine, .uploadCacheCounts, .uploadCacheEntryCount, Entry (+17 more)

### Community 77 - "Coordinator"
Cohesion: 0.16
Nodes (12): DispatchWorkItem, .body, Coordinator, LayerStackListView, Context, Coordinator, UILongPressGestureRecognizer, UIPinchGestureRecognizer (+4 more)
...
### Community 88 - "ParityScenario"
Cohesion: 0.12
Nodes (22): UIImage, UInt8, Backdrop, fill, image, none, Gesture, diagonalCut (+14 more)
...
### Community 93 - "InterpolationRecipe"
Cohesion: 0.06
Nodes (47): CGPathElementType, ContentProvider, Direction, backward, forward, fromRest, Evaluation, GroupWarp (+39 more)
...
### Community 121 - ".source"
Cohesion: 0.33
Nodes (5): CanvasManager, .renderLeafOrder, .renderTree, stack, UUID
...
Cohesion: 0.13
Nodes (12): GuideRole, both, timing, trajectory, KeyframeInterval, Bool, Decoder, TimeInterval (+4 more)
...
Cohesion: 0.22
Nodes (13): CoreGraphicsCompositor, CGImage, CGRect, Double, UIImage, UInt8, Attempt, image (+5 more)
...
### Community 140 - "SelectionMode"
Cohesion: 0.11
Nodes (18): CanvasManager, Entry, Bool, Cel, CGSize, UIImage, UUID, ThumbnailBatch (+10 more)
...
Cohesion: 0.13
Nodes (9): GuidePath, .end, .start, SpacingChart, .curve, .draggable, Int, Range (+1 more)
...
Cohesion: 0.14
Nodes (16): MTLLibrary, MTLTextureUsage, EffectPipelines, MetalEffectEngine, Bool, Int, MTLCommandQueue, MTLComputeCommandEncoder (+8 more)
...
### Community 176 - ".report"
Cohesion: 0.21
Nodes (9): UUID, ParityReport, .diagnostic, .isExact, RasterVectorParity, Bool, Int, UIImage (+1 more)
...
### Community 178 - "VectorPreviewPlanLogicTests"
Cohesion: 0.13
...
### Community 189 - "ColorPickerPanel"
Cohesion: 0.14
Nodes (16): ColorPickerPanel, .body, .colorTab, .currentColor, .hexRow, .hueSlider, .palettesTab, .renameAlertBinding (+8 more)
...
### Community 227 - "TransformMode"
Cohesion: 0.22
Nodes (8): TransformMode, .displayName, distort, freeform, .id, .isImplemented, uniform, warp

### Community 229 - "ParityPixel"
Cohesion: 0.50
Nodes (4): CustomStringConvertible, ParityPixel, .description, UInt8

### Community 230 - "effectChannels"
Cohesion: 0.70
...
## Knowledge Gaps
- **947 isolated node(s):** `graphify-guard.sh script`, `gallery`, `sizePicker`, `editor`, `.now` (+942 more)
...
- **Why does `CGFloat` connect `CGFloat` to `PaintUITestCase`, `CGPoint`, `TimelineRowView`, `CanvasManager`, `ShapeOverlayView`, `Brush`, `cels`, `StrokeCanvasView`, `ActionRecorder`, `BrushEngineLogicTests`, `StrokeGeometryLogicTests`, `VectorEraserLogicTests`, `.transparentFormat`, `layers`, `CanvasManager`, `ARAPLogicTests`, `VectorEraserHybridLogicTests`, `PerfBaselineTests`, `RasterLayerTexture`, `Binding`, `Coordinator`, `FloatingPieceOverlayView`, `AnimationTimeline`, `LayerStackCell`, `VectorCanvas`, `EraserSettingsPanel`, `FontResolveLogicTests`, `WindowEventTap`, `SideToolbar`, `TextOverlayView`, `XCUIApplication`, `BrushStamper`, `Lattice`, `ProjectStore`, `StrokeStabilizer`, `String`, `CompositorParityLogicTests`, `CanvasManager`, `View`, `.apply`, `Coordinator`, `DrawingView`, `SandwichLogicTests`, `VectorCanvasDataLogicTests`, `TextBakeCharacterizationTests`, `ParityScenario`, `.setBakedContent`, `PointCloudIndex`, `InterpolationRecipe`, `InterpolationRenderLogicTests`, `InterpolationModelLogicTests`, `GuideOverlayView`, `DeformFactorization`, `LayerContentVersion`, `StrokeSampleGateLogicTests`, `InterpolationGuideLogicTests`, `.indices`, `CanvasManager`, `InterpolationEngineDiagnosticsLogicTests`, `Typography`, `.arched`, `TimedSample`, `InterpolateBar`, `.launchIntoEditor`, `RenderRequest`, `TextHitTestLogicTests`, `.manager`, `SpacingChart`, `OnionSkinSource.swift`, `TransformOverlaySupport.swift`, `LassoFillLogicTests`, `CanvasManager`, `PinchMergeGateLogicTests`, `VectorSample`, `Coordinator`, `CanvasManager`, `CanvasTransformFreezeUITests`, `LayerStackListView.Coordinator`, `Alignment`, `CurveEditor`, `.compositeSize`, `JSONValue`, `.report`, `.image`, `CGRect`, `SandwichCompositingUITests`, `.sample`, `CodingKeys`, `ActionsMenu`, `TextSettingsPanel`, `TimelineLayoutKeyLogicTests`, `CGContextDabTarget`, `TextLayout`, `.relayout`, `TimelineLayoutKey`, `.frames`, `.path`?**
  _High betweenness centrality (0.257) - this node is a cross-community bridge._
- **Why does `CGPoint` connect `CGPoint` to `InterpolationEngineDiagnosticsLogicTests`, `Typography`, `EyedropperLogicTests`, `TimelineRowView`, `TimedSample`, `CanvasManager`, `.arched`, `ShapeOverlayView`, `Brush`, `cels`, `StrokeCanvasView`, `.manager`, `BrushEngineLogicTests`, `SpacingChart`, `TextFrame`, `StrokeGeometryLogicTests`, `VectorEraserLogicTests`, `.setUpGestures`, `.transparentFormat`, `layers`, `CanvasManager`, `ARAPLogicTests`, `VectorSample`, `CanvasManager`, `CanvasManager`, `Coordinator`, `LassoFillLogicTests`, `PerfBaselineTests`, `VectorEraserHybridLogicTests`, `RasterLayerTexture`, `LayerStackListView.Coordinator`, `Coordinator`, `CurveEditor`, `AnimationTimeline`, `FloatingPieceOverlayView`, `ProjectSaveLogicTests`, `VectorCanvas`, `VectorCanvasData`, `SelectionOverlayView`, `.report`, `WindowEventTap`, `Corner`, `TextOverlayView`, `ObjectTransformOverlayView`, `CGRect`, `BrushStamper`, `Lattice`, `.sample`, `ColorPickerPanel`, `StrokeStabilizer`, `AlphaMask`, `TextHitTestLogicTests`, `CanvasManager`, `.rasterize`, `FillGestureRestartLogicTests`, `.sampledColor`, `CGFloat`, `CGContextDabTarget`, `TextLayout`, `CanvasManager`, `TextBakeCharacterizationTests`, `ParityScenario`, `PointCloudIndex`, `.frames`, `InterpolationRecipe`, `.path`, `TransformOverlaySupport.swift`, `InterpolationRenderLogicTests`, `InterpolationModelLogicTests`, `GuideOverlayView`, `DeformFactorization`, `StrokeSampleGateLogicTests`, `InterpolationGuideLogicTests`, `.indices`?**
  _High betweenness centrality (0.163) - this node is a cross-community bridge._
- **Why does `XCTestCase` connect `XCTestCase` to `PaintUITestCase`, `InterpolationEngineDiagnosticsLogicTests`, `ProjectBackupManager`, `.manager`, `EyedropperLogicTests`, `CGPoint`, `Typography`, `VectorCanvasData`, `cels`, `TextHitTestLogicTests`, `BrushEngineLogicTests`, `CanvasNotice`, `UIKit`, `StrokeGeometryLogicTests`, `TextFrame`, `VectorEraserLogicTests`, `LassoFillLogicTests`, `ARAPLogicTests`, `PinchMergeGateLogicTests`, `VectorEraserHybridLogicTests`, `PerfBaselineTests`, `ShapeHoldClock`, `StrokeGestureRecognizer`, `VectorEraserMode`, `ProjectSaveLogicTests`, `RenderTreeCharacterizationTests`, `FontResolveLogicTests`, `VectorPreviewPlanLogicTests`, `MaskGuardLogicTests`, `OnionSkinLogicTests`, `Lattice`, `AlphaMask`, `FillBoundaryLogicTests`, `CompositorParityLogicTests`, `GalleryOpenState`, `FillGestureRestartLogicTests`, `TimelineLayoutKeyLogicTests`, `LayerTreeCharacterizationTests`, `SelectionOverlayLogicTests`, `CanvasPresentationLogicTests`, `SandwichLogicTests`, `VectorCanvasDataLogicTests`, `TextBakeCharacterizationTests`, `ParityScenario`, `.setBakedContent`, `EffectMultiPassLogicTests`, `InterpolationRenderLogicTests`, `InterpolationModelLogicTests`, `PlaybackBoundsCharacterizationTests`, `EffectParityLogicTests`, `BlockDragCharacterizationTests`, `StrokeSampleGateLogicTests`, `InterpolationGuideLogicTests`?**
