...
## Corpus Check
- 260 files · ~966,241 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8098 nodes · 25169 edges · 246 communities (229 shown, 17 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 2504 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `17af9c4c`
...
- `HomographyLogicTests` --calls--> `Quad`  [INFERRED]
  PaintSoftwareUITests/HomographyLogicTests.swift → PaintSoftware/Engine/Deform/Quad.swift
...
### Community 0 - ".performDrag"
Cohesion: 0.15
Nodes (6): Int, InterpolationWorkflowUITests, Bool, TimeInterval, XCUIElement, TimelineGestureUITests
...
Cohesion: 0.08
Nodes (32): DateFormatter, Decodable, Cel, Layer, ManifestSkeleton, Notification.Name, ProjectBackup, .id (+24 more)

### Community 3 - ".manager"
Cohesion: 0.05
Nodes (11): CanvasFixture, CanvasManager, Int, CelCRUDCharacterizationTests, CanvasManager, Int, SelectionPersistenceLogicTests, CGPath (+3 more)
...
Cohesion: 0.03
Nodes (68): Never, Void, CanvasManager, .activeContainerID, .activeLayerIsVector, .activeLayerKind, .availableBrushes, .availableEraserBrushes (+60 more)

### Community 8 - "Quad"
Cohesion: 0.11
Nodes (15): Bool, Quad, .area, .boundingBox, .centre, .isConvex, .isSimple, .parallelogramDefect (+7 more)
...
Cohesion: 0.07
Nodes (29): CAShapeLayer, StrokeInput, TimeInterval, UITouch, UIView, NSCoder, StrokeCanvasView, .brush (+21 more)
...
### Community 16 - "UIKit"
Cohesion: 0.04
Nodes (15): Combine, CoreGraphics, CoreText, Darwin, Foundation, Metal, TextMeasure, LayerTransform (+7 more)

### Community 17 - "StrokeGeometryLogicTests"
Cohesion: 0.05
Nodes (15): MembershipRun, Capsule, .boundingBox, Intersection, StrokeGeometry, Bool, CGRect, ClosedRange (+7 more)

### Community 18 - "CGFloat"
Cohesion: 0.06
Nodes (14): CGFloat, Sweep, Bool, CGRect, ClosedRange, Double, VectorEraser, samples (+6 more)

### Community 19 - "LassoMoveLogicTests"
Cohesion: 0.12
Nodes (12): .elements, text, LassoMoveLogicTests, Bool, CanvasManager, CGAffineTransform, CGImage, CGPath (+4 more)
...
Cohesion: 0.12
Nodes (11): CanvasManager, StructureSnapshot, Int, Layer, CanvasManager, Int, String, Bool (+3 more)
...
### Community 35 - ".makeUIView"
Cohesion: 0.11
Nodes (11): AppliedTool, CanvasView, CanvasManager, CGAffineTransform, Color, Context, Coordinator, Double (+3 more)
...
Cohesion: 0.05
Nodes (59): AnyObject, CGPathFillRule, Identifiable, DabTarget, VectorTextElement, CodableColor, .uiColor, image (+51 more)
...
Cohesion: 0.06
Nodes (29): LassoFillDiagnostic, CGPath, Double, TimeInterval, UIImage, UUID, resolvedLastTouchType(), UITouch (+21 more)

### Community 44 - "FillGestureRestartLogicTests"
Cohesion: 0.22
...
Cohesion: 0.08
Nodes (19): App, task, AppScreen, editor, gallery, sizePicker, ContentView, .body (+11 more)
...
### Community 48 - "Homography"
Cohesion: 0.14
Nodes (10): CATransform3D, Homography, .catransform3D, .determinant, .inverse, CGAffineTransform, CGRect, CGSize (+2 more)

### Community 49 - "Codable"
Cohesion: 0.10
Nodes (29): Codable, CompositorRole, node, Decoder, Encoder, K, KeyedDecodingContainer, LayerKind (+21 more)
...
Cohesion: 0.11
Nodes (26): Hasher, CanvasManager, LayerContentVersion, LayerRenderSource, RenderBackground, RenderRequest, RenderResolution, full (+18 more)
...
Cohesion: 0.07
Nodes (14): AlphaMask, .isActive, Bool, Decoder, Int, CGImage, CGRect, UInt8 (+6 more)

### Community 61 - "ProjectStore"
Cohesion: 0.08
Nodes (45): CFAbsoluteTime, os, T, CelContent, CodableColor, .color, Color, .codable (+37 more)
...
Cohesion: 0.04
Nodes (45): CanvasManager, .activeCelIsInBetween, .guideChips, .guideRefusal, .hasAnonymousWholeFrameGroup, .interpolationCommitOptions, .interpolationContentProvider, .interpolationKeyframes (+37 more)
...
Cohesion: 0.06
Nodes (31): LayerHostView, .maskedContentViews, Bool, CALayer, CGImage, ActiveObjectTransform, Coordinator, .canvasContentScale (+23 more)

### Community 81 - "DrawingView"
Cohesion: 0.09
Nodes (18): ActionRecorderIndicator, .body, CanvasNoticeBanner, .body, .icon, String, Void, DamagedSaveBanner (+10 more)
...
### Community 91 - "WarpAgreementCharacterizationTests"
Cohesion: 0.20
Nodes (8): CGImage, CGRect, String, UInt8, WarpAgreementCharacterizationTests, .quads, .sourceScale, WarpParams
...
### Community 116 - "ValueFill"
Cohesion: 0.04
Nodes (55): CodingKey, CodingKeys, activeCells, cellSize, cols, originX, originY, rows (+47 more)
...
Cohesion: 0.08
Nodes (16): Effect, .displayName, .input, .kind, .kindCode, .params, .passes, .reshapesCoverage (+8 more)
...
Cohesion: 0.12
Nodes (16): Kind, folder, layer, MaskSource, folder, .id, layer, Encoder (+8 more)

### Community 122 - "VectorSample"
Cohesion: 0.11
Nodes (9): VectorSample, StrokeSampleGate, Bool, CountingDabTarget, StrokeSampleGateLogicTests, CGBlendMode, UIColor, UInt64 (+1 more)
...
Cohesion: 0.05
Nodes (38): Hashable, CodingKeys, boundGroups, id, interval, role, samples, GuideRole (+30 more)
...
Cohesion: 0.11
Nodes (6): BlendModesAndCompositorUITests, LayerPanelUITests, XCUIApplication, String, XCUIApplication, UndoAndLayerHistoryUITests
...
### Community 149 - "ToolLogicTests"
Cohesion: 0.11
Nodes (3): Bool, Tool, ToolLogicTests

### Community 150 - "CanvasManager"
Cohesion: 0.07
Nodes (37): CanvasManager, .canResetFloating, .freeformUnavailableReason, .isAnyPieceFloating, .mirrorUnavailableReason, .vectorFloatIsFreeform, FixedAngleRotation, FloatingPiece (+29 more)
...
Cohesion: 0.08
Nodes (28): CaseIterable, FillMode, .displayName, flood, .id, lasso, Bool, String (+20 more)
...
### Community 162 - "HomographyLogicTests"
Cohesion: 0.17
Nodes (4): HomographyLogicTests, StaticString, String, UInt
...
### Community 170 - "EffectPipelines"
Cohesion: 0.07
Nodes (27): MTLLibrary, EffectPipelines, MetalEffectEngine, Bool, Int, MTLCommandQueue, MTLComputeCommandEncoder, MTLComputePipelineState (+19 more)
...
Cohesion: 0.06
Nodes (32): Alignment, center, .displayName, .id, justified, left, right, CodingKeys (+24 more)

### Community 176 - "BrushStamper"
Cohesion: 0.10
Nodes (14): BrushStamper, DabRNG, DiscardedDabTarget, Sample, Bool, CGBlendMode, ClosedRange, Double (+6 more)
...
Cohesion: 0.20
Nodes (9): CGGradient, Key, CGContextDabTarget, DabGradientCache, Key, CGBlendMode, CGContext, UIColor (+1 more)
...
### Community 190 - "MetalWarpEngine"
Cohesion: 0.16
Nodes (10): MetalWarpEngine, Float, Int, MTLCommandQueue, MTLComputePipelineState, MTLDevice, MTLTexture, MTLTextureUsage (+2 more)
...
### Community 204 - ".warpedImage"
Cohesion: 0.43
Nodes (4): ImageWarp, CGImage, CGRect, CGSize
...
### Community 216 - ".render"
Cohesion: 0.40
Nodes (3): CGSize, UIImage, ThumbnailRenderer

### Community 217 - "Neighbourhood"
Cohesion: 0.40
...
### Community 219 - "Coordinator"
Cohesion: 0.16
Nodes (13): DispatchWorkItem, .body, Coordinator, LayerStackListView, CanvasManager, Coordinator, Int, Set (+5 more)
...
Cohesion: 0.20
Nodes (8): Handoff — 2026-08-27 (session 71), Start here — paste this to begin the next session, State, Still open, unchanged, The review that did not merge, and why it was worth its cost, Two hazards learned the hard way, both now in CLAUDE.md, What landed, What the owner's device report settled
...
Cohesion: 0.13
Nodes (27): Equatable, Bloom, Blur, BrightnessContrast, ChromaticAberration, value, Curves, .lookupTable (+19 more)
...
Cohesion: 0.04
Nodes (63): Error, CodingKeys, brush, color, composite, elements, fill, fills (+55 more)

### Community 252 - "TextFrame"
Cohesion: 0.06
Nodes (40): Int, Basis, Corner, bottomLeft, bottomRight, topLeft, topRight, Handle (+32 more)
...
## Knowledge Gaps
- **1188 isolated node(s):** `In flight`, `(8) Fixed-point sample coordinates — SETTLED, build it`, `(12) A layer should not have a *resolution* — bake geometry into canvas coordinates`, `(14) A reversible Move: hold the transform in doubles until an explicit bake`, `(13) Canvas padding shares one 16k budget, and the base maximum rises` (+1183 more)
...
- **Why does `CGFloat` connect `CGFloat` to `.performDrag`, `CGPoint`, `TimelineRowView`, `CanvasManager`, `Quad`, `ShapeOverlayView`, `PointCloudIndex`, `cels`, `StrokeCanvasView`, `ActionRecorder`, `BrushEngineLogicTests`, `TextTransformLogicTests`, `UIKit`, `StrokeGeometryLogicTests`, `LassoMoveLogicTests`, `.transparentFormat`, `CanvasManager`, `PerfBaselineTests`, `RasterLayerTexture`, `Binding`, `.makeUIView`, `FloatingPieceOverlayView`, `AnimationTimeline`, `ProjectSaveLogicTests`, `LayerStackCell`, `VectorCanvas`, `PerfMonitor`, `Homography`, `WindowEventTap`, `SideToolbar`, `ARAPLogicTests`, `TextOverlayView`, `ObjectTransformLogicTests`, `XCUIApplication`, `RenderRequest`, `OnionSkinSource.swift`, `ProjectStore`, `StrokeStabilizer`, `SizePreviewRequest`, `.solidImage`, `CanvasManager`, `.rows`, `.apply`, `CompositorMetalEngine`, `LayerRowModel`, `Coordinator`, `DrawingView`, `SandwichLogicTests`, `VectorCanvasDataLogicTests`, `TextBakeCharacterizationTests`, `UInt8`, `.setBakedContent`, `WarpAgreementCharacterizationTests`, `.evaluate`, `InterpolationRenderLogicTests`, `.refreshUndoRedoState`, `ShapeDetector`, `GuideOverlayView`, `StrokeSpatialIndex`, `VectorEraserHybridLogicTests`, `VectorSample`, `InterpolationGuideLogicTests`, `TextTransformOverlayView`, `FontDescriptor`, `CanvasManager`, `Typography`, `InterpolationRecipe`, `InterpolateBar`, `XCUIApplication`, `TextHitTestLogicTests`, `CanvasManager`, `Brush`, `TextRecipe`, `CanvasManager`, `PinchMergeGateLogicTests`, `.previewed`, `VectorFloat`, `CanvasTransformFreezeUITests`, `InterpolationEngineDiagnosticsLogicTests`, `HomographyLogicTests`, `CurveEditor`, `DeformFactorization`, `VectorTransformUndoLogicTests`, `.compositeSize`, `JSONValue`, `CodingKeys`, `BrushStamper`, `.image`, `CGContextDabTarget`, `CGRect`, `.sample`, `SandwichCompositingUITests`, `ActionsMenu`, `TextSettingsPanel`, `.relayout`, `LassoFillLogicTests`, `TimelineLayoutKeyLogicTests`, `.frames`, `SpacingChart`, `.rasterize`, `.warpedImage`, `Kind`, `Lattice`, `RecordingDabTarget`, `Coordinator`, `TimelineLayoutKey`, `Coordinator`, `.lassoFill`, `Kind`, `.attach`, `.draw`, `String`, `TextFrame`?**
  _High betweenness centrality (0.294) - this node is a cross-community bridge._
- **Why does `CGPoint` connect `CGPoint` to `.manager`, `TimelineRowView`, `ColorPickerPanel`, `CanvasManager`, `Quad`, `ShapeOverlayView`, `PointCloudIndex`, `cels`, `StrokeCanvasView`, `BrushEngineLogicTests`, `TextTransformLogicTests`, `UIKit`, `StrokeGeometryLogicTests`, `CGFloat`, `LassoMoveLogicTests`, `.transparentFormat`, `.withStructureUndo`, `CanvasManager`, `PerfBaselineTests`, `RasterLayerTexture`, `.makeUIView`, `FloatingPieceOverlayView`, `AnimationTimeline`, `ProjectSaveLogicTests`, `VectorCanvas`, `SelectionOverlayView`, `FillGestureRestartLogicTests`, `Homography`, `WindowEventTap`, `ARAPLogicTests`, `TextOverlayView`, `ObjectTransformLogicTests`, `AlphaMask`, `StrokeStabilizer`, `SizePreviewRequest`, `CanvasManager`, `SaveDamageGateLogicTests`, `Coordinator`, `TextBakeCharacterizationTests`, `WarpAgreementCharacterizationTests`, `.evaluate`, `InterpolationRenderLogicTests`, `.refreshUndoRedoState`, `ShapeDetector`, `GuideOverlayView`, `StrokeSpatialIndex`, `VectorEraserHybridLogicTests`, `VectorSample`, `InterpolationGuideLogicTests`, `TextTransformOverlayView`, `Typography`, `EyedropperLogicTests`, `InterpolationRecipe`, `.setUpGestures`, `TextHitTestLogicTests`, `CanvasManager`, `Brush`, `TextRecipe`, `ToolLogicTests`, `CanvasManager`, `VectorFloat`, `LayerStackListView.Coordinator`, `InterpolationEngineDiagnosticsLogicTests`, `HomographyLogicTests`, `CurveEditor`, `DeformFactorization`, `VectorTransformUndoLogicTests`, `BrushStamper`, `CGContextDabTarget`, `TextRecipeCodableLogicTests`, `CGRect`, `.sample`, `LassoFillLogicTests`, `.frames`, `SpacingChart`, `.rasterize`, `.warpedImage`, `Kind`, `Lattice`, `RecordingDabTarget`, `Coordinator`, `CanvasManager`, `.sampledColor`, `String`, `TextFrame`?**
  _High betweenness centrality (0.176) - this node is a cross-community bridge._
- **Why does `XCTestCase` connect `XCTestCase` to `CGPoint`, `Typography`, `.manager`, `EyedropperLogicTests`, `InterpolationRecipe`, `cels`, `TextHitTestLogicTests`, `BrushEngineLogicTests`, `CanvasNotice`, `UIKit`, `OnionSkinLogicTests`, `StrokeGeometryLogicTests`, `LassoMoveLogicTests`, `TextTransformLogicTests`, `ToolLogicTests`, `CGFloat`, `PinchMergeGateLogicTests`, `.previewed`, `PaintUITestCase`, `.validateProject`, `PerfBaselineTests`, `ShapeHoldClock`, `StrokeGestureRecognizer`, `InterpolationEngineDiagnosticsLogicTests`, `HomographyLogicTests`, `ProjectSaveLogicTests`, `VectorTransformUndoLogicTests`, `ValueLayerLogicTests`, `SelectionOverlayView`, `FillGestureRestartLogicTests`, `EffectPipelines`, `ARAPLogicTests`, `ObjectTransformLogicTests`, `TextRecipeCodableLogicTests`, `CanvasTouchInputs`, `AlphaMask`, `FillBoundaryLogicTests`, `.solidImage`, `UndoHistory`, `GalleryOpenState`, `SaveDamageGateLogicTests`, `LassoFillLogicTests`, `TimelineLayoutKeyLogicTests`, `LayerTreeCharacterizationTests`, `CanvasPresentationLogicTests`, `Lattice`, `SandwichLogicTests`, `VectorCanvasDataLogicTests`, `TextBakeCharacterizationTests`, `.setBakedContent`, `WarpAgreementCharacterizationTests`, `EffectMultiPassLogicTests`, `InterpolationRenderLogicTests`, `MaskGuardLogicTests`, `PlaybackBoundsCharacterizationTests`, `Effect`, `BlockDragCharacterizationTests`, `VectorEraserHybridLogicTests`, `String`, `VectorSample`, `InterpolationGuideLogicTests`, `FontDescriptor`?**
...
- **Are the 16 inferred relationships involving `CGFloat` (e.g. with `.draw()` and `.rasterize()`) actually correct?**
  _`CGFloat` has 16 INFERRED edges - model-reasoned connections that need verification._
- **Are the 45 inferred relationships involving `VectorCanvas` (e.g. with `.composite()` and `.testEvictionKeepsTheCelsNearestTheCurrentFrameAndDropsTheRest()`) actually correct?**
  _`VectorCanvas` has 45 INFERRED edges - model-reasoned connections that need verification._