...
## Corpus Check
- 144 files · ~299,539 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3479 nodes · 10078 edges · 125 communities (116 shown, 9 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 1246 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fcaeab56`
...
### Community 3 - ".manager"
Cohesion: 0.05
Nodes (23): PreviousCelOnionSkinSource, CanvasFixture, CanvasManager, Int, Layer, StaticString, String, UInt (+15 more)

### Community 4 - "TimelineRowView"
Cohesion: 0.06
Nodes (42): CelBlockView, Coordinator, Kind, cel, gap, Segment, Bool, CanvasManager (+34 more)
...
Cohesion: 0.05
Nodes (44): CanvasManager, .activeLayerKind, .availableBrushes, .availableEraserBrushes, .currentFrame, .currentLayerIndex, .effectiveLoopRange, .hasLoopBoundary (+36 more)
...
Cohesion: 0.11
Nodes (19): kind, Bool, CGAffineTransform, CGContext, CGRect, CGSize, VectorCanvas, .elements (+11 more)
...
Cohesion: 0.11
Nodes (21): Void, StrokeInput, StrokeCanvasView, .brush, .isNoScratchRole, .pencilOnlyDrawing, .raster, .vectorCanvas (+13 more)
...
Cohesion: 0.08
Nodes (21): LayerHostView, NSCoder, AppliedTool, CanvasView, Coordinator, InterpolationPreviewKey, Bool, CanvasManager (+13 more)
...
### Community 25 - "cels"
Cohesion: 0.08
Nodes (20): cels, InterpolationReferenceOnionSkinSource, OnionSkinSource, InterpolationMotionGroupLogicTests, .twoBodiesAtRest, .twoBodiesMoved, CanvasManager, Cel (+12 more)
...
### Community 40 - ".load"
Cohesion: 0.14
Nodes (22): Decodable, Cel, Layer, ManifestSkeleton, Cel, Layer, CelContent, LayerContent (+14 more)
...
### Community 51 - "UIKit"
Cohesion: 0.12
Nodes (6): Combine, Darwin, ThumbnailRenderer, PhotosUI, SwiftUI, UIKit
...
Cohesion: 0.10
Nodes (20): 10. Open items (not blocking Phase 0–1), 11. Moving vector rendering to the GPU, 2.1 The eraser *is* a stroke, 2.2 Unified display list, 2.3 Persistence, 2. Data model, 3.1 `StrokeGeometry` (pure functions), 3.2 `StrokeSpatialIndex` (+12 more)
...
Cohesion: 0.14
Nodes (18): CodableColor, .uiColor, DabLattice, .range, StrokeComposite, erase, paint, CGPath (+10 more)
...
Cohesion: 0.10
Nodes (16): CanvasManager, .interpolationContentProvider, .interpolationKeyframes, .interpolationReferenceCanvases, .interpolationTarget, GroupRegistration, RegistrationElement, Bool (+8 more)
...
Cohesion: 0.12
Nodes (26): Codable, Equatable, Hashable, GuideRole, both, timing, trajectory, GuideStroke (+18 more)
...
Cohesion: 0.12
Nodes (20): ElementData, fill, image, stroke, ImageRef, Kind, fill, image (+12 more)
...
### Community 112 - "VectorScratchRole"
Cohesion: 0.33
...
### Community 117 - "Coordinator"
Cohesion: 0.24
Nodes (8): NSObject, Coordinator, LayerStackListView, CanvasManager, Coordinator, Void, UITableViewDiffableDataSource, UIViewRepresentable

### Community 118 - "4. Per-mode implementation"
Cohesion: 0.50
Nodes (4): 4. Per-mode implementation, Mode 1 — Erase, Mode 2 — Cut points (rewrite of what exists), Mode 3 — Cut to intersection

### Community 119 - "SpacingCurve"
Cohesion: 0.19
Nodes (7): Kind, easeIn, easeInOut, easeOut, linear, sampled, SpacingCurve
...
## Knowledge Gaps
- **559 isolated node(s):** `graphify-guard.sh script`, `gallery`, `sizePicker`, `editor`, `softRound` (+554 more)
...
- **Why does `CGFloat` connect `CGFloat` to `.launchIntoEditor`, `VectorEraserHybridLogicTests`, `.manager`, `TimelineRowView`, `CanvasManager`, `StrokeGeometryLogicTests`, `ShapeOverlayView`, `VectorEraserLogicTests`, `VectorCanvas`, `BrushEngineLogicTests`, `ShapeGeometry`, `CanvasManager`, `StrokeCanvasView`, `InterpolationRenderLogicTests`, `PointCloudIndex`, `Coordinator`, `.transparentFormat`, `CodingKeys`, `CanvasManager`, `CanvasManager`, `cels`, `VectorSample`, `.stampStroke`, `PerfBaselineTests`, `StrokeSpatialIndex`, `StrokeSettingsPanel`, `AnimationTimeline`, `.load`, `CGPoint`, `InterpolationModelLogicTests`, `BrushDynamics`, `RasterLayerTexture`, `DabTarget`, `StrokeGeometry`, `DeformFactorization`, `Color`, `Lattice`, `LayerStackCell`, `SideToolbar`, `ARAPLogicTests`, `ObjectTransformOverlayView`, `VectorFillElement`, `StrokeStabilizer`, `EraserSettingsPanel`, `CanvasManager`, `Equatable`, `InterpolationEngineDiagnosticsLogicTests`, `CoreGraphics`, `DrawingView`, `Identifiable`, `InterpolateBar`, `LayerStackListView.Coordinator`, `.registerGroups`, `.setUpGestures`, `TransformOverlaySupport.swift`, `ActionsMenu`, `Coordinator`, `SpacingCurve`, `.group`?**
  _High betweenness centrality (0.311) - this node is a cross-community bridge._
- **Why does `CGPoint` connect `CGPoint` to `VectorEraserHybridLogicTests`, `TimelineRowView`, `CanvasManager`, `StrokeGeometryLogicTests`, `ShapeOverlayView`, `VectorEraserLogicTests`, `VectorCanvas`, `BrushEngineLogicTests`, `ShapeGeometry`, `CanvasManager`, `StrokeCanvasView`, `InterpolationRenderLogicTests`, `PointCloudIndex`, `Coordinator`, `.transparentFormat`, `CanvasManager`, `CanvasManager`, `cels`, `VectorSample`, `.stampStroke`, `PerfBaselineTests`, `layers`, `StrokeSpatialIndex`, `AnimationTimeline`, `FloatingPieceOverlayView`, `ColorPickerPanel`, `InterpolationModelLogicTests`, `ProjectSaveLogicTests`, `BrushDynamics`, `SelectionOverlayView`, `RasterLayerTexture`, `DabTarget`, `StrokeGeometry`, `DeformFactorization`, `Lattice`, `ARAPLogicTests`, `ObjectTransformOverlayView`, `StrokeStabilizer`, `CanvasManager`, `Equatable`, `InterpolationEngineDiagnosticsLogicTests`, `CGFloat`, `CoreGraphics`, `Identifiable`, `LayerStackListView.Coordinator`, `.registerGroups`, `.setUpGestures`, `String`, `TransformOverlaySupport.swift`, `Foundation`, `.group`?**
  _High betweenness centrality (0.219) - this node is a cross-community bridge._
- **Why does `CanvasManager` connect `CanvasManager` to `ShapeGeometry`, `CanvasManager`, `CanvasManager`, `CanvasManager`, `MetalFillEngine`, `VectorSample`, `layers`, `CanvasManager`, `ViewPreset`, `RasterLayerTexture`, `UIKit`, `PerfMonitor`, `VectorEraserMode`, `ProjectManifest`, `MotionGroup`, `UndoHistory`, `Equatable`, `CGFloat`, `Identifiable`, `StructureSnapshot`?**
