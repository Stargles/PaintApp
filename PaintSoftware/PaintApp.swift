...
struct PaintApp: App {
    init() {
        ...
        // Inert unless an XCUITest passed `-uiTestTextureBudgetBytes`, and simulator-only. First,
        // because every memo in the app reads this number and one of them is filled before the first
