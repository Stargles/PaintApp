...
enum BrushLibrary {
    static let softRound = Brush(
        ...
        spacingFraction: 0.08, stabilization: 0.25,
    ...
    static let hardRound = Brush(
        ...
        spacingFraction: 0.05, stabilization: 0.1,
    ...
    static let pencil = Brush(
        ...
        opacity: 0.9, spacingFraction: 0.04, stabilization: 0.15,
    ...
    static let pen = Brush(
        ...
        opacity: 1, spacingFraction: 0.03, stabilization: 0.4,
