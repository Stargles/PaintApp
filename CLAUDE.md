...
**ROADMAP.md was deleted 2026-08-30.** Its six long-term features are [TODO.md](TODO.md) items (21) and
(26)-(30), in that file's "Later" section — the owner's call, because a second file meant those features
were never going to be built while TODO kept growing. **Every one of them still ends with the
conversation it needs**: the owner asked to be prompted before any is designed, and an item built from
its TODO entry alone was built wrong.
