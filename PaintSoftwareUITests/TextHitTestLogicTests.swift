...
final class TextHitTestLogicTests: XCTestCase {
    ...
    private static func testBrush() -> Brush {
        Brush(name: "Test", tip: .round, size: 10, opacity: 1, dab: BrushDabSettings(flow: 1, spacing: 0.1, hardness: 1, angle: BrushAngleSettings(jitter: 0)), stroke: BrushStrokeSettings(stabilization: 0, blendMode: .normal))
    }
